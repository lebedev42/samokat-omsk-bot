...
export const MENU_RULES_RESPONSE_1 =
  "Перейдём к правилам. Чтобы выиграть билеты на хоккей или джерси, нужно копить баллы за заказы в приложении Самоката. Один балл — это один чек на сумму 600 ₽. Два балла — чек на 1200 ₽ и так далее.\n\nОбязательно введите промокод АВАНГАРД600 перед покупкой. Загружайте ссылку на чек в бот. Мы пополним ваш индивидуальный счёт в течение нескольких часов.";
export const MENU_RULES_RESPONSE_2 = "Где найти чек?";
export const MENU_RULES_RESPONSE_3 =
  "В приложении Самоката зайдите в личный кабинет. В разделе «Заказы» выберите тот, что подходит под условия конкурса. Нажмите кнопку «Чеки заказа» под суммой покупки. Перейдите по ссылке, введите защитный код и скопируйте ссылку на чек.";
...
export const RULES_TEXT_LINK = `Остались вопросы?\nПодробнее о правилах розыгрыша можно узнать <a href='${S3_BASE_URL}/sm-error.png'>тут</a>`;
